...
public class ScorerCombo {
	...
	public static int REGULATION_NUM_INNINGS = 9;
	...
	public static void readScores(Scanner scores, int[] visitorScores, int[] homeScores) {
		...
		while (!gameIsOver(inning, batter, visitorScores, homeScores)) {
			...
			if (batter == VISITORS) {
				...
				batter = HOME;
				gameIsOver(inning, batter, visitorScores, homeScores);
			}
			if (batter == HOME) {
				if (inning == REGULATION_NUM_INNINGS && gameScore(visitorScores) < gameScore(homeScores)) {
					break;
				}
	...
	public static String result(int[] visitorScores, int[] homeScores) {
		...
		printBoxScore(" Visitor: ", visitorScores);
	...
	public static void main(String[] args) {
		...
		if (answer.charAt(0) == 'y' || answer.charAt(0) == 'Y') {
			...
			// Call innings to get # of innings
			// Call result version 2
			// Your code goes here.
		}
